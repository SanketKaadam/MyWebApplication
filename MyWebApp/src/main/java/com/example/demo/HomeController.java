...
public class HomeController 
{
	...
	public ModelAndView home(Employee Employee) // now client sending multiple data so insist of writing @Requestparam 3 times and accept data we use object to accept multiple data.
	{
